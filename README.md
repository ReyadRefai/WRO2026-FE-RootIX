...
| **11** | **Raspberry Pi 5 Camera Cable (15-Pin to 22-Pin)** | <img width="383" height="305" alt="لقطة شاشة 2026-07-21 144434" src="https://github.com/user-attachments/assets/21327ba5-e015-4010-90d2-919e782024f2" /> | 1 | 35 ILS | • Connectors: 15-Pin (1.0mm pitch) to 22-Pin (0.5mm pitch).<br>• Length: 15cm.<br>• Type: FPC high-speed CSI cable. | • **CSI Interface Adapter:** Bridges standard 15-pin camera modules to the high-density 22-pin mini-CSI port on the Raspberry Pi 5 without signal loss. |
| **12** | **Micro HDMI Cable** | <img width="363" height="343" alt="لقطة شاشة 2026-07-21 144733" src="https://github.com/user-attachments/assets/3439e8d4-c97e-4da2-8276-2e2761332fd5" />| 1 | 35 ILS | • Type: Micro HDMI to Standard HDMI. | • **Display Connection:** Connects the Raspberry Pi micro HDMI port to an external monitor for system configuration and UI interaction. |
