...
| **14** | **ESP32 Development Board (38-Pin NodeMCU-32S Version)** | <img width="1045" height="716" alt="لقطة شاشة 2026-07-17 201337" src="https://github.com/user-attachments/assets/f6debb63-7b38-40cc-9a55-4545388d4e9b" /> | 1 | 30 ILS | • Tensilica Xtensa dual-core 32-bit LX6 CPU.<br> | • Deterministic Low-Level Actuation Core: Dedicated exclusively to hardware-timed tasks, executing precise PWM signals for drive motors and steering servos, while managing real-time ToF sensor polling via I2C. |
